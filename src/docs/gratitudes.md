...
- `GratitudeWidget` — виджет на дашборде. Шапка с кнопкой «Поблагодарить», до 3 последних полученных благодарностей, ссылка «Все благодарности →» inline с подзаголовком «Последние полученные». Пустое состояние при отсутствии полученных
