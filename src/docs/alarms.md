...
Порог: 5% до следующего чекпоинта (кратный 20, без верхней границы — 20/40/60/80/100/120/140/…). Если метка уже менялась с последнего чекпоинта — аларм не создаётся.
