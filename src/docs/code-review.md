...
**Формат файла ревью:** в файл с ревью писать **только найденные проблемы** — баги, нарушения правил, замечания. Чеклисты не копировать, пройденные пункты не перечислять. Если всё ок — не упоминать.
