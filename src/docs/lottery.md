...
Ежемесячный розыгрыш дорогого лота. Сотрудники покупают билеты за 💎, победитель определяется рандомом.
...
Возврат 💎 проигравшим не делается — весь смысл в выводе 💎 из оборота. Отмена лотереи невозможна.
...
- `LotteryAdmin` — админский компонент: создание, редактирование приза (с предупреждением при наличии купленных билетов), текущая статистика, история
