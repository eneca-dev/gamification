...
export const dashboardTour: OnboardingTour = {
  ...
  steps: [
    ...
    },
    {
      ...
      description:
        'Ваш отдел соревнуется с другими по корректному ведению Worksection и использованию автоматизаций. Учитывается доля вовлеченных сотрудников — чем больше людей из отдела активны, тем выше позиция в рейтинге. Итоги в конце месяца. Наведите на ℹ️, чтобы узнать формулу расчёта. Ниже — такое же соревнование для команд с аналогичным принуипом работы.',
      placement: 'top',
    },
    {
