  ...
  steps: [
    {
      ...
      description:
        'Товары разделены по категориям. Для физических категорий отслеживается остаток для вашего удобства. Цифровые и неисчисляемые товары не имеют ограничений по количеству.',
      placement: 'bottom',
    },
    {
