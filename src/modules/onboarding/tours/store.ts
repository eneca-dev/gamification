  ...
  steps: [
    {
      ...
      description:
        'Тратьте заработанные кристаллы 💎 на реальные награды! Товары разделены по категориям — выбирайте нужную. Некоторые товары имеют ограниченное количество — следите за наличием.',
      placement: 'bottom',
    },
    {
      id: 'store-product',
      ...
      description:
        'Цена указана в кристаллах 💎. Если баланса хватает — нажмите «Получить». Если нет — кнопка покажет, сколько ещё нужно накопить. Товары с пометкой «Осталось: N» скоро закончатся!',
      placement: 'right',
    },
    {
      id: 'store-my-orders',
