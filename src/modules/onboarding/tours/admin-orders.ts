  ...
  steps: [
    {
      ...
      description:
        'Фильтры быстро покажут заказы по статусу. Цифровые заказы выполняются автоматически. При отмене заказа кристаллы 💎 возвращаются покупателю — отмена необратима.',
      placement: 'bottom',
    },
    {
