...
const AREA_RULES: Record<AchievementArea, Record<AchievementEntityType, string>> = {
  revit: {
    user: 'Попадите в топ-10 сотрудников по Revit-баллам и продержитесь 10 дней за месяц. Баллы = 💎 за использование плагинов + стрик-бонусы.',
  ...
  ws: {
    user: 'Попадите в топ-10 сотрудников по WS-баллам и продержитесь 10 дней за месяц. Баллы = 💎 за зелёные дни, стрики и бюджет.',
