...
const AREA_RULES: Record<AchievementArea, Record<AchievementEntityType, string>> = {
  revit: {
    user: 'Попадите в топ-10 сотрудников по Revit-баллам и продержитесь 10 дней за месяц. Баллы = коины за использование плагинов + стрик-бонусы.',
    team: 'Ваша команда должна попасть в топ-5 команд по Revit и продержаться 10 дней. Формула: баллы команды с учётом вовлечённости.',
    department: 'Ваш отдел должен попасть в топ-5 отделов по Revit и продержаться 10 дней. Формула: баллы отдела с учётом вовлечённости.',
  },
  ws: {
    user: 'Попадите в топ-10 сотрудников по WS-баллам и продержитесь 10 дней за месяц. Баллы = коины за зелёные дни, стрики и бюджет.',
    team: 'Ваша команда должна попасть в топ-5 команд по WS и продержаться 10 дней. Формула: баллы команды с учётом вовлечённости.',
    department: 'Ваш отдел должен попасть в топ-5 отделов по WS и продержаться 10 дней. Формула: баллы отдела с учётом вовлечённости.',
  },
  gratitude: {
