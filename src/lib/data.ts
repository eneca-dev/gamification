...
export const worksectionStatus = {
  percent: 100,
  status: "perfect" as const, // "perfect" | "warning"
  label: "Идеально!",
...
export const storeProducts = [
  // Организационные и фановые привилегии
  {
    id: 1,
    name: "Именная табличка на дверь/стол",
    emoji: "🏷️",
    price: 500,
    category: "fun",
    tag: "Доступно",
  ...
  {
    id: 2,
    name: "Переходящий кубок / тотем на стол",
    emoji: "🏆",
    price: 800,
    category: "fun",
    tag: "Фан",
  ...
  {
    id: 4,
    name: "Начальник на подхвате (15 мин)",
    emoji: "🫡",
    price: 2500,
    category: "fun",
    tag: "Эксклюзив",
  ...
  {
    id: 7,
    name: "Завтрак на столе (круассан и сок)",
    emoji: "🥐",
    price: 300,
    category: "food",
    tag: "Доступно",
  ...
  {
    id: 8,
    name: "Оплата такси (разовая поездка)",
    emoji: "🚕",
    price: 400,
    category: "food",
    tag: "Транспорт",
  ...
  {
    id: 11,
    name: "Суши-сет на команду",
    emoji: "🍣",
    price: 1800,
    category: "food",
    tag: "Для команды",
  },
  // Сертификаты, подписки и мерч
  {
    id: 12,
    name: "Сертификат (Ozon / Золотое Яблоко / Steam, 50 BYN)",
    emoji: "🎫",
    price: 500,
    category: "merch",
    tag: "Доступно",
  ...
  {
    id: 13,
    name: "Подписка (Telegram Premium / Яндекс.Плюс / ChatGPT Plus, 3 мес.)",
    emoji: "⭐",
    price: 750,
    category: "merch",
    tag: "Подписка",
  ...
  {
    id: 14,
    name: "Премиальная термокружка (Yeti/Kambukka)",
    emoji: "🍵",
    price: 2200,
    category: "merch",
    tag: "Мерч",
  ...
  {
    id: 16,
    name: "Городской рюкзак (Thule/XD Design)",
    emoji: "🎒",
    price: 6000,
    category: "merch",
    tag: "Премиум",
  ...
  {
    id: 17,
    name: "Оплата профильного обучения/курса",
    emoji: "🎓",
    price: 5000,
    category: "merch",
    tag: "Развитие",
  ...
  {
    id: 18,
    name: "Большой премиальный коврик на стол",
    emoji: "🖥️",
    price: 1500,
    category: "upgrade",
    tag: "Апгрейд",
  ...
  {
    id: 19,
    name: "Лампа на монитор (скринбар)",
    emoji: "💡",
    price: 2500,
    category: "upgrade",
    tag: "Апгрейд",
  ...
  {
    id: 20,
    name: "Эргономичная подставка для ног",
    emoji: "🦶",
    price: 3000,
    category: "upgrade",
    tag: "Апгрейд",
  ...
  {
    id: 21,
    name: "Вертикальная мышь (эргономичная)",
    emoji: "🖱️",
    price: 4000,
    category: "upgrade",
    tag: "Апгрейд",
  ...
  {
    id: 23,
    name: "Механическая клавиатура (Keychron/Logitech)",
    emoji: "⌨️",
    price: 6500,
    category: "upgrade",
    tag: "Апгрейд",
  ...
  {
    id: 24,
    name: "Ортопедическое или геймерское кресло",
    emoji: "🪑",
    price: 15000,
    category: "upgrade",
    tag: "Премиум",
  ...
  {
    id: 25,
    name: "Настольная игра для команды",
    emoji: "🎲",
    price: 1800,
    category: "fun",
    tag: "Для команды",
...
export const achievements = [
  {
    ...
    earned: true,
    date: "15 сент. 2025",
    description: "Заработайте первый Проект-коин",
  },
  {
    id: 2,
    name: "Неделя порядка",
    ...
    earned: true,
    date: "22 сент. 2025",
    description: "Держите Worksection зеленым 1 неделю",
  },
  {
    id: 3,
    ...
    earned: true,
    date: "15 окт. 2025",
    description: "Держите Worksection зеленым 1 месяц",
  },
  {
    id: 4,
    name: "Автоматизатор",
    ...
    earned: true,
    date: "3 нояб. 2025",
    description: "Используйте 50 автоматизаций Revit",
  },
  {
    id: 5,
    name: "Щедрая душа",
    ...
    earned: true,
    date: "10 дек. 2025",
    description: "Отправьте 10 благодарностей",
  },
  {
    id: 6,
    name: "Квартал стабильности",
    icon: "🏆",
    earned: false,
    date: null,
    description: "Держите Worksection зеленым 3 месяца подряд",
  },
  {
    id: 7,
    name: "Тысячник",
    ...
    earned: true,
    date: "28 окт. 2025",
    description: "Накопите 1 000 Проект-коинов",
  },
  {
    id: 8,
    name: "Первая покупка",
  ...
  },
  {
    ...
    earned: false,
    date: null,
    description: "Накопите 10 000 Проект-коинов",
  },
  {
    id: 10,
    ...
    earned: false,
    date: null,
    description: "Используйте все автоматизации Revit за неделю",
  },
  {
    id: 11,
    name: "Команда мечты",
    ...
    earned: false,
    date: null,
    description: "Получите благодарность от 5 разных коллег",
  },
  {
    id: 12,
    name: "Марафонец",
    ...
    earned: false,
    date: null,
    description: "Держите Worksection зеленым 6 месяцев подряд",
  },
];
...
export const teamActivity = [
  ...
  },
  {
    ...
    avatar: "АК",
    avatarColor: "#2196f3",
    action: "получил ачивку",
    target: "Месяц дисциплины",
    emoji: "🏅",
  ...
  },
  {
    ...
    avatar: "ОН",
    avatarColor: "#9c27b0",
    action: "отправила благодарность",
    target: "Ивану Петрову",
    emoji: "💚",
    time: "1 час назад",
  ...
  },
  {
    ...
    avatarColor: "#ff9800",
    action: "заработал",
    target: "+120 за автоматизацию Revit",
    emoji: "⚡",
    time: "1 час назад",
  ...
  },
  {
    ...
    avatarColor: "#607d8b",
    action: "достиг серии",
    target: "8 зелёных недель подряд",
    emoji: "🔥",
    time: "3 часа назад",
